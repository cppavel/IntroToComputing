...
;enables P2.10 for GPIO
;no input or output params
enableGPIO
	PUSH{R4-R5,lr}
...
; waitBtnDn - waits before the button is pressed down, simulates the behaviour of real button: when released it goes up
; has no input or output params
waitBtnDn
	PUSH{R4-R7,lr}
...
whBtnDn
	...
	LDR	R6, =FIO2PIN1		
	LDRB	R7, [R6]							;read FIO2PIN1
	ORR	R7, R7, R5								;set bit 2 (release button)
	; write new FIO2PIN1 value
	STRB	R7, [R6]
